...
from semilearn.core.criterions import CELoss, ConsistencyLoss, FocalLoss, SymmetricLoss
...
class AlgorithmBase:
    ...
    def __init__(
        ...
        **kwargs):
        ...
        self.amp_cm = (lambda: torch.amp.autocast("cuda")) if self.use_amp else contextlib.nullcontext
        self.gpu = args.gpu
        self.rank = args.rank
    ...
    def set_model(self):
        ...
        initialize model
        """
        if self.args.net_from_name:
            model = self.net_builder()
            # print out all resnet layer
            state_dict = torch.load(self.args.pretrain_path, map_location='cpu')
    ...
    def train(self):
        ...
        for epoch in range(self.start_epoch, self.epochs):
            ...
            for data_lb, data_ulb in zip(self.loader_dict['train_lb'],
                ...
                processed_batch = self.process_batch(**data_lb, **data_ulb)
